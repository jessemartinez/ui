...
(function ($, fluid) {
    ...
    cspace.includeLocalDemands = function () {
		...
		fluid.demands("select", ["cspace.recordList", "cspace.localData", "work", "cspace.relatedRecordsList"], {
            funcName: "cspace.recordList.selectNavigateVocab",
            args: ["{recordList}.model", "{recordList}.options", "{recordList}.options.urls.navigateLocal", "{permissionsResolver}", "{recordList}.dom"]
        });
    ...
    cspace.includeDemands = function () {
		...
		fluid.demands("cspace.autocomplete", ["cspace.recordEditor", "work", "cspace.hierarchy"], {
            container: "{arguments}.0",
            mergeAllOptions: [{
                invokers: {
                    handlePermissions: {
...
//                },
		...
		fluid.demands("cspace.recordList", ["cspace.relatedRecordsList", "work"], {
            container: "{relatedRecordsList}.dom.recordListSelector",
            options: {
                columns: ["number", "summary", "sourceFieldName"],
                strings: {
		...
		fluid.demands("select", ["cspace.recordList", "work", "cspace.relatedRecordsList"], {
            funcName: "cspace.recordList.selectNavigateVocab",
            args: ["{recordList}.model", "{recordList}.options", "{recordList}.options.urls.navigate", "{permissionsResolver}", "{recordList}.dom"]
        });
		...
		fluid.demands("relationManager", ["cspace.relatedRecordsList", "work"], {
            container: "{relatedRecordsList}.dom.relationManagerSelector", 
            options: {
                components: {
                    showAddButton: {
        ...
        // Structured date demands for work authority
        ...
        // Structured date demands for cataloging procedure
        ...
        // Structured date demands for person authority
        ...
        fluid.demands("cspace.workStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            ...
            mergeAllOptions: [{
                ...
                listeners: {
                    ...
                    recordEditorOnRefreshView: "{workStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
        ...
        fluid.demands("cspace.catalogingStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            ...
            mergeAllOptions: [{
                ...
                listeners: {
                    ...
                    recordEditorOnRefreshView: "{catalogingStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
        ...
        fluid.demands("cspace.personStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            ...
            mergeAllOptions: [{
                ...
                listeners: {
                    ...
                    recordEditorOnRefreshView: "{personStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
		...
		fluid.demands("sidebar", ["cspace.pageBuilder", "work"], {
            container: "{pageBuilder}.options.selectors.sidebar",
            options: {
                primaryRecordType: "{pageBuilder}.options.pageType",
                recordApplier: "{pageBuilder}.applier",
